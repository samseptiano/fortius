...
fun String.isNumeric(): Boolean {
 ...
 fun Activity.showDialogVersion(lastVersion:String, action:()-> Unit) {
     if(lastVersion != BuildConfig.VERSION_NAME) {
         AlertDialog.Builder(this)
             .setTitle(getString(R.string.alert_update_app))
             .setMessage(getString(R.string.alert_update_app_desc))
             .setPositiveButton(
